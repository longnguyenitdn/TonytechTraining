          ...
          <div className="header-mid flex-row align-center flex-bet">
            <div className="search flex-row align-center flex-around">
              <div className="search-icon">
                <button className=" input bg-trans marg10 cursor btn-bg">
                  <HiMagnifyingGlass className="font-sz20" />
                </button>
              </div>
              <div className="input-search-wrap flex-row">
                <input
                  className="input-search input bg-trans font-sz20"
                  type="text"
                  placeholder="Search..."
                />
                <button className="btn-bg cursor">
                  <HiXMark className="font-sz20" />
                </button>
              </div>
            </div>

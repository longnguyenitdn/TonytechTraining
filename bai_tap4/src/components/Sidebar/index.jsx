            ...
            <>
              {this.state.isEditLabelModal === true && (
                <SidebarEditLabelModal
                  handleShowHideEditLabelModalFunc={
                    this.handleShowHideEditLabelModal
                  }
                ...
                <div id="sidebar" className="sidebar flex-col">
                  <div
                    ...
                    className={`flex-row sidebar-row sidebar-row-top align-center cursor active-menu ${
                      provider.state.activeId === "sidebar_btn_note"
                        ? "active"
                        : ""
                    }`}
                    onClick={(e) => {
                  ...
                  <div
                    ...
                    className={`flex-row sidebar-row sidebar-row-top align-center cursor active-menu ${
                      provider.state.activeId === "sidebar_btn_reminder"
                        ? "active"
                        : ""
                    }`}
                    onClick={(e) => {
                  ...
                  <div
                    ...
                    className={`flex-row sidebar-row sidebar-row-top align-center cursor active-menu ${
                      provider.state.activeId === "sidebar_btn_archive"
                        ? "active"
                        : ""
                    }`}
                    onClick={(e) => {
                  ...
                  <div
                    ...
                    className={`flex-row sidebar-row sidebar-row-top align-center cursor active-menu ${
                      provider.state.activeId === "sidebar_btn_trash"
                        ? "active"
                        : ""
                    }`}
                    onClick={(e) => {

      ...
      return (
         <>
            {this.props.noteList.map(item => {
               return (
                  <div key={item.id} className={`notes-cover flex-row  ${item.id === this.props.delayNote.id ? this.props.delayClass : ''}`} onClick={(e) => this.props.handleShowHideOpenDetailModalFunc(e,item)}>
                     <div className="note"  >
                        <div className="note-wrap">
                           ...
                           <div className="note-icon flex-row flex-bet">
                              <NoteBtnIcon><CiBullhorn /></NoteBtnIcon>
                              <NoteBtnIcon><TbUserPlus /></NoteBtnIcon>
                              <NoteBtnIcon><BsPalette /></NoteBtnIcon>
                              <NoteBtnIcon><BsImages /></NoteBtnIcon>
                              <NoteBtnIcon><BsBoxArrowDown /></NoteBtnIcon>
                              <button onClick={(e) => this.props.handleClickOpenNoteOptionFunc(item.id, e)} className="hiden btn-note-option button-icon cursor font-sz15 void-clicks display-note-icon"><HiOutlineEllipsisVertical /></button>
                           </div>
                        </div>
                     </div>
                  </div>
